            ...
            <div className="container">
                <div className="panel panel-default">
                    ...
                    <div className="panel-body">
                        <h4><Link to={`/show/${this.state.key}`} className="btn btn-primary">Article List</Link></h4>
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" name="body" value={this.state.body} onChange={this.onChange} placeholder="Body" />
                            </div>
                            <div className="form-group">
